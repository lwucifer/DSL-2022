  ...
  <client-only>
    <div class="page-booking-wrapper">
      <div class="container">
        <div class="row">
          <div
            v-if="!$route.path.includes('/booking/product-travel/pre-order/result')"
            class="col-md-4"
          >
          ...
          <div
            ...
            :class="
              !$route.path.includes('/booking/product-travel/pre-order/result')
                ? 'col-md-8'
                : 'col-12'
            "
          >
...
export default {
  ...
  created() {
    this.setHeaderPaymentSteps([
      {
        text: this.$t('product.pre_order'),
        routePath: `/booking/product-travel/pre-order`
      },
      {
        text: this.$t('booking.success'),
        routePath: `/booking/product-travel/pre-order/result`
      }
    ]);
  },
